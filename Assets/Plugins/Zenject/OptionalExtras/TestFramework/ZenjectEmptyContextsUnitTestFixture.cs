...
namespace Zenject
{
    public abstract class ZenjectEmptyContextsUnitTestFixture
    {
        ...
        protected void PreInstall()
        {
            ...
            var testProjectContext = new GameObject("TestProjectContext").AddComponent<ProjectContext>();
            testProjectContext.Initialize();
            ProjectContext.Instance = testProjectContext;
