...
namespace Zenject.Internal
{
    public static class ZenMenuItems
    {
        ...
        [MenuItem("Assets/Create/Zenject/Unit Test (Empty Contexts)", false, 60)]
        public static void CreateEmptyContextsUnitTest()
        {
            AddCSharpClassTemplate("Scene Test Fixture", "UntitledUnitTest",
                "using Zenject;"
                + "\nusing System.Collections;"
                + "\nusing UnityEngine.TestTools;"
                + "\n"
                + "\npublic class CLASS_NAME : ZenjectEmptyContextsUnitTestFixture"
                + "\n{"
                + "\n    [UnityTest]"
                + "\n    public IEnumerator RunTest1()"
                + "\n    {"
