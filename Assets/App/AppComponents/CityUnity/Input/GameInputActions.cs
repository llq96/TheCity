...
//     version 1.8.2
//     from Assets/App/AppComponents/CityUnity/Input/GameInputActions.inputactions
//
...
public partial class @GameInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@GameInputActions()
    {
        Debug.Assert(!m_Time.enabled, "This will cause a leak and performance issues, GameInputActions.Time.Disable() has not been called.");
    }
    ...
    public struct TimeActions
    {
        ...
        public TimeActions(@GameInputActions wrapper) { m_Wrapper = wrapper; }
